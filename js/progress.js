  ...
  function importProgress(file) {
    ...
    reader.onload = function (e) {
      try {
        ...
        _showToast(`[OK] ${count} progress items restored! Reloading...`);
    ...
    return `
      <div class="progress-modal" role="dialog" aria-modal="true" aria-labelledby="progress-modal-title">
        <div class="pm-header">
          ...
          <button class="pm-close" onclick="OmicsLab.Progress.closeModal()" aria-label="Close"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" aria-hidden="true"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg></button>
        </div>
