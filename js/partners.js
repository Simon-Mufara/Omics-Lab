  ...
  function init() {
    ...
    section.innerHTML = `
      <div class="pr-wrap">
        ...
        <!-- Developer spotlight -->
        <div class="pr-section-label">Creator &amp; Lead Developer</div>
        <div class="pr-dev-card">
          <img class="pr-dev-photo" src="images/simon-mufara.jpg" alt="Simon Mufara" loading="lazy">
          <div class="pr-dev-info">
            <div class="pr-dev-name">Simon Mufara</div>
            <div class="pr-dev-role">Computational Biologist &amp; Bioinformatician · UCT</div>
            <div class="pr-dev-bio">Built OmicsLab to make professional-grade omics training accessible to every African researcher — online, offline, and in their own language. All tools, modules, and embedded apps in this platform are independently designed and developed by Simon.</div>
            <div class="pr-dev-links">
              <a class="pr-dev-link" href="https://github.com/Simon-Mufara" target="_blank" rel="noopener">
              ...
              <a class="pr-dev-link" href="mailto:kaykayxsimon@gmail.com">
        ...
        <!-- Other contributors -->
        <div class="pr-section-label" style="margin-top:1.5rem">Contributors</div>
        <div class="pr-contributors">
          ${CONTRIBUTORS.filter(c => c.name !== 'Simon Mufara').concat([CONTRIBUTORS.find(c => c.name === 'Open Contributions')]).filter(Boolean).map(c => `<div class="pr-contrib-card">
