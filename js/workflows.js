...
OmicsLab.REAGENTS = {
  ...
  'no-ab':         { label: 'No antibody (ctrl)', emoji: '❌', cat: 'Antibody' },
  /* Kits */
  ...
  'no-istd':       { label: 'No Internal Std',    emoji: '❌', cat: 'Standard' },
  /* Misc */
...
OmicsLab.Workflows['wgs'] = {
  ...
  name:'Whole Genome Sequencing', difficulty:'intermediate', icon:'🧬',
  ...
  steps:[
    dragStep('dna-source','Sample Preparation','Select Sample Type',
      ...
      0,'🩸','DNA Extraction Tube','Drop sample type here',
    ...
    dragStep('dna-extraction','Sample Preparation','DNA Extraction Kit',
      ...
      0,'🔬','Spin Column / Bead Mill','Drag extraction kit here',
...
OmicsLab.Workflows['wes'] = {
  ...
  name:'Whole Exome Sequencing', difficulty:'beginner', icon:'🔭',
  color:'var(--genomics)', colorHex:'#58a6ff',
  ...
  steps:[
    dragStep('dna-wes','Sample Preparation','Sample & DNA Extraction',
      ...
      0,'🔬','DNA Column','Drop extraction kit here',
...
OmicsLab.Workflows['rna-seq'] = {
  ...
  name:'Bulk RNA-seq', difficulty:'beginner', icon:'📊',
  ...
  steps:[
    dragStep('rna-sample','Sample Preparation','Select RNA Source',
      ...
      0,'🧊','Homogenisation Tube','Drop sample here',
    ...
    dragStep('rna-extraction','RNA Extraction','RNA Extraction Method',
      ...
      0,'🔬','RNA Extraction Column','Drag kit here',
...
OmicsLab.Workflows['scrna-seq'] = {
  ...
  name:'scRNA-seq (10x Chromium)', difficulty:'intermediate', icon:'🔬',
  color:'var(--transcripto)', colorHex:'#3fb950',
  ...
  steps:[
    dragStep('dissociation','Sample Preparation','Tissue Dissociation Enzyme',
      ...
      0,'🫧','Dissociation Tube','Drop dissociation enzyme here',
    ...
    dragStep('gem-chip','10x Chromium Loading','Select 10x Chromium Chip',
      ...
      2,'🔬','Chromium Controller','Drop chip version here',
...
OmicsLab.Workflows['atac-seq'] = {
  ...
  name:'ATAC-seq', difficulty:'intermediate', icon:'🔓',
  ...
  steps:[
    dragStep('atac-lysis','Nuclei Isolation','Select Lysis Buffer',
      ...
      0,'🔬','Nuclei Isolation Tube','Drop lysis buffer here',
...
OmicsLab.Workflows['chip-seq'] = {
  ...
  name:'ChIP-seq', difficulty:'advanced', icon:'🧲',
  color:'var(--epigenomics)', colorHex:'#d2a8ff',
  ...
  steps:[
    ...
    dragStep('antibody','Immunoprecipitation','Select Antibody',
      ...
      2,'🧪','IP Tube + Protein A/G Beads','Drop antibody here',
...
OmicsLab.Workflows['shotgun-meta'] = {
  ...
  name:'Shotgun Metagenomics', difficulty:'intermediate', icon:'🦠',
  ...
  steps:[
    dragStep('meta-extraction','DNA Extraction','Select Metagenomic DNA Extraction Kit',
      ...
      0,'🪨','Bead Beating Tube + Column','Drop extraction kit here',
...
OmicsLab.Workflows['16s-amplicon'] = {
  ...
  name:'16S rRNA Amplicon Sequencing', difficulty:'beginner', icon:'🔁',
  color:'var(--metagenomics)', colorHex:'#ffa657',
  ...
  steps:[
    dragStep('16s-dna','DNA Extraction','DNA Extraction Kit for Stool/Soil',
      ...
      0,'💩','Bead Beating + Column','Drop extraction kit here',
    ...
    dragStep('16s-primers','PCR Amplification','Select 16S Primer Pair',
      ...
      1,'🔬','PCR Tube (Hot-start Polymerase)','Drop primer pair here',
...
OmicsLab.Workflows['lc-ms'] = {
  ...
  name:'LC-MS Untargeted Metabolomics', difficulty:'intermediate', icon:'⚗️',
  ...
  steps:[
    dragStep('meta-sample','Sample Preparation','Sample Type for Metabolomics',
      ...
      0,'🧊','Pre-cooled Collection Tube','Drop sample type here',
    ...
    dragStep('protein-precip','Protein Precipitation','Protein Precipitation Solvent',
      ...
      0,'🧪','Precipitation Tube (ice)','Drop precipitation solvent here',
    ...
    dragStep('istd','Sample Preparation','Internal Standard Addition',
      ...
      0,'⚖️','Sample Tube (before extraction)','Drop internal standard here',
      ['istd-mix','no-istd'],
...
OmicsLab.Workflows['proteomics'] = {
  ...
  name:'Shotgun Proteomics (LC-MS/MS)', difficulty:'intermediate', icon:'🔩',
  ...
  steps:[
    ...
    dragStep('reduct-alkyl','Sample Preparation','Reduction & Alkylation Reagents',
      ...
      0,'🧪','Reduction Tube (60°C, 30 min)','Drop reducing agent here',
    ...
    dragStep('protease','Protein Digestion','Select Digestion Protease',
      ...
      1,'⚗️','Digestion Tube (37°C, 16h)','Drop protease here',
...
OmicsLab.Workflows['viral-wgs'] = {
  ...
  name:'Viral Whole Genome Sequencing', difficulty:'intermediate', icon:'🦠',
  ...
  steps:[
    dragStep('viral-rna','RNA Extraction','Viral RNA Extraction Kit',
      ...
      0,'🔬','RNA Extraction Column','Drop extraction kit here',
    ...
    dragStep('artic-primers','RT-PCR & Amplification','Select ARTIC Primer Pool',
      ...
      1,'🧬','RT-PCR Tube (multiplex)','Drop primer scheme here',
...
OmicsLab.Workflows['cite-seq'] = {
  ...
  name:'CITE-seq (RNA + Protein)', difficulty:'advanced', icon:'🎯',
  ...
  steps:[
    dragStep('cite-ab','Cell Staining','CITE-seq Antibody Panel',
      ...
      0,'🏷️','Cell Suspension (4°C)','Drop antibody panel here',
    ...
    dragStep('cite-chip','10x Loading','Select CITE-seq Compatible Chip',
      ...
      1,'🔬','Chromium Controller','Drop chip here',
...
OmicsLab.DOMAINS = [
  { id:'genomics',       label:'Genomics',        icon:'🧬', color:'var(--genomics)',    colorHex:'#58a6ff', rgb:'88,166,255', badge:'badge-blue',
    desc:'Map the complete DNA sequence of an organism or characterise variants linked to disease.',
    workflows:['wgs','wes'] },
  { id:'transcriptomics',label:'Transcriptomics', icon:'📊', color:'var(--transcripto)', colorHex:'#3fb950', rgb:'63,185,80',  badge:'badge-green',
    desc:'Quantify gene expression at population (bulk) or single-cell resolution.',
    workflows:['rna-seq','scrna-seq'] },
  { id:'epigenomics',    label:'Epigenomics',     icon:'🔓', color:'var(--epigenomics)', colorHex:'#d2a8ff', rgb:'210,168,255',badge:'badge-blue',
    desc:'Profile chromatin accessibility, histone modifications, and DNA methylation.',
    workflows:['atac-seq','chip-seq'] },
  { id:'metagenomics',   label:'Metagenomics',    icon:'🦠', color:'var(--metagenomics)',colorHex:'#ffa657', rgb:'255,166,87', badge:'badge-orange',
  ...
  { id:'metabolomics',   label:'Metabolomics',    icon:'⚗️',  color:'var(--metabolomics)',colorHex:'#f78166', rgb:'247,129,102',badge:'badge-red',
    desc:'Profile the small-molecule metabolites reflecting cellular and physiological state.',
    workflows:['lc-ms'] },
  { id:'proteomics',     label:'Proteomics',      icon:'🔩', color:'var(--proteomics)',  colorHex:'#79c0ff', rgb:'121,192,255',badge:'badge-blue',
    desc:'Identify and quantify proteins and their modifications at the whole-proteome level.',
    workflows:['proteomics'] },
  { id:'virology',       label:'Virology',        icon:'🧫', color:'var(--virology)',    colorHex:'#ff7b72', rgb:'255,123,114',badge:'badge-red',
    desc:'Sequence and characterise viral genomes for outbreak surveillance and strain typing.',
    workflows:['viral-wgs'] },
  { id:'multiomics',     label:'Multi-omics',     icon:'🎯', color:'var(--multiomics)',  colorHex:'#e3b341', rgb:'227,179,65', badge:'badge-orange',
