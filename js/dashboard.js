...
OmicsLab.Dashboard = (function () {
  ...
  function _injectStyles() {
    ...
    s.id = 'db-styles';
    s.textContent = `
      .db-wrap{background:linear-gradient(135deg,rgba(63,185,80,.03),rgba(88,166,255,.02));border-bottom:1px solid var(--border-default,#21262d);padding:1rem 1.5rem .85rem;margin-bottom:.5rem}
      ...
      .db-hello{font-size:.95rem;font-weight:700;color:var(--text-primary,#e6edf3)}
      .db-inst{font-size:.75rem;color:var(--text-muted,#8b949e);margin-left:.55rem}
      ...
      .db-card{background:var(--bg-surface,#161b22);border:1px solid var(--border-default,#21262d);border-radius:9px;padding:.65rem .75rem}
      .db-card-title{display:flex;align-items:center;gap:.3rem;font-size:.68rem;font-weight:700;color:var(--text-faint,#484f58);text-transform:uppercase;letter-spacing:.05em;margin-bottom:.55rem}
      ...
      .db-pulse-country{font-weight:600;color:var(--text-secondary,#c9d1d9);flex-shrink:0}
      .db-pulse-event{color:var(--text-muted,#8b949e);line-height:1.4}
    `;
