...
OmicsLab.App = (function() {
  ...
  function printReport() {
    ...
    reportWin.document.write(`<!DOCTYPE html><html><head>
      ...
      <div class="footer">Generated by OmicsLab Simulator — omicsdatalab.tech — For educational purposes only</div>
    </body></html>`);
  ...
  function shareResults(wfName, score) {
    ...
    const url  = 'https://omicsdatalab.tech/';
    if (navigator.share) {
...
/* _showSwBanner removed — update banner is owned by pwa.js _showUpdateBanner */
